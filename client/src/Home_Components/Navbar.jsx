...
function Navbar() {
  return (
    <div className="w-full h-[12vh] bg-white shadow flex items-center">
  {/* Left: Logo + Brand */}
  ...
  <div className="w-2/4 h-full flex items-center justify-center   bg-white">
    <ul className="flex  text-lg font-medium gap-30 text-gray-700">
  ...
  <div className='w-1/4 h-full  flex items-center justify-center   bg-white'>
